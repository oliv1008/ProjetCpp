...
$(IntermediateDirectory)/src_CException.cpp$(ObjectSuffix): src/CException.cpp $(IntermediateDirectory)/src_CException.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/olivier/Bureau/Polytech/ProjetCpp/src/CException.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_CException.cpp$(ObjectSuffix) $(IncludePath)
